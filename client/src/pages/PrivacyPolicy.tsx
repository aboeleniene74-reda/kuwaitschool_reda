    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50" dir="rtl">
      ...
      <div className="bg-gradient-to-l from-blue-600 to-green-600 text-white py-16">
        <div className="container max-w-4xl">
          ...
          <p className="text-xl text-blue-50">منصة جيولوجيا ثانوي الكويت - studygeology.k8</p>
      ...
      <div className="container max-w-4xl py-12 space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-lg leading-relaxed">
            <p>
              نحن في **منصة جيولوجيا ثانوي الكويت** نلتزم بحماية خصوصيتك وأمان بياناتك الشخصية. توضح هذه السياسة كيفية جمع واستخدام وحماية المعلومات التي تقدمها عند استخدام منصتنا التعليمية.
            </p>
            <p>
